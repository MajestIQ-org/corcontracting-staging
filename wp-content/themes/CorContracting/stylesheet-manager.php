<link rel="stylesheet"
    href="<?php echo get_stylesheet_directory_uri(); ?>/assets/libraries/bootstrap-5-3/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/libraries/owl/owl.carousel.min.css">
...
<?php if (is_front_page()): ?>
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/why-choose-us.css">
<?php endif; ?>
<?php if (is_page(83)): ?>
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/banner.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/faq.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/page-faq.css">
<?php endif; ?>

<?php if (is_page(17)): ?>
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/banner.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/contact.css">
<?php endif; ?>
...
<?php if (is_page(15)): ?>
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/gallery.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/section-cta.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/banner.css">
<?php endif; ?>
