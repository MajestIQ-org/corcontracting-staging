...
<section class="global-banner ">
    <div class="container-fluid">
        <div class="wrapper">
            <div class="header_content text-center mx-auto">
                <?php if ($sub = get_field('subheading')): ?>
                    <p class="fs-14 subheading text-gold mb-16"><?php echo esc_html($sub); ?></p>
                <?php endif; ?>

                <?php if ($heading = get_field('heading')): ?>
                    <h1 class=" text-white mb-32"><?php echo esc_html($heading); ?></h1>
                <?php endif; ?>
                <div class="d-flex justify-content-center  mb-16 gap-2 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-star h-10 w-10 md:h-12 md:w-12 fill-gold text-gold">
                        <path
