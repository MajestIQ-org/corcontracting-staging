    ...
    <div class="container-fluid">
        <div class="wrapper">
            <div class="header_content">
                <p class="fs-14 subheading text-gold mb-16">Blog</p>
                <h1 class=" text-white mb-16">Remodeling Tips & Ideas</h1>
                <p class="mb-0">Expert advice for your next home improvement project.</p>
            </div>
        </div>
    </div>
</section>
                        ...
                        <?php while ($query->have_posts()):
                            ...
                            <article class="blog-card">
                                ...
                                <div class="content">
                                    ...
                                    <div class="mb-16 excerpt"><?php the_excerpt(); ?></div>
                                    <a href="<?php the_permalink(); ?>" class="d-flex fs-14 text-gold read-more">Read More <svg
